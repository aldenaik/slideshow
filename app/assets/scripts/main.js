$(document).ready(function() {
    ...
    $( ".right, #rightTitle" ).mouseup(function(e) {       //Right Click
        $("#rightPlacement").css("-webkit-animation","none");  //turns off openeing animation of hands
...
//            console.log(window.lastClickedElement.attr)

            var active = screenCarousel.pop();
...
//            console.log(screenCarousel)
            ...
            var active = screenCarousel.shift();
            screenCarousel.push(active)
            var active = screenCarousel.shift();         //second pop so that it gets the correctly ordered object from array
//            console.log(screenCarousel)
//            console.log(active)
